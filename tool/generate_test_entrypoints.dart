...
/// Creates entry points for test files in the "test" folder.
///
/// Run this script and then execute for example `dart test test/_test.dart`.
///
...
void generateTestEntrypoint(String folder) {
  ...
  entryPoint.writeln("import 'package:test/test.dart';");
